        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 ">
                    ...
                    <form action="{{ route('trainingCRUD.store') }}" method="post">
                        @csrf  <!-- Security Token -->

                        <div class="mb-3">
                            <label for="day">Dia</label>
                            <input type="date" class="mt-1 block w-full" style="@error('day') border-color:RED; @enderror" name="day">
                            @error('day')
                                <div>{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="mt-1 block w-full" style="@error('hour') border-color:RED; @enderror" name="hour">
                            @error('hour')
                                <div>{{$message}}</div>
                            @enderror
                        </div>
